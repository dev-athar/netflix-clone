...
export default function FAQ() {
  ...
  return (
    <div className="w-full mx-auto p-20 bg-black text-white text-center">
      ...
      <ul className="">
        <li onClick={() => toggleExpand("whatIsNetflix")} className="w-full">
          <p className="w-full text-lg cursor-pointer bg-white bg-opacity-15 p-5 pl-5  hover:bg-opacity-25 text-left">
            What is Netflix?
          </p>
          {expandedSegment === "whatIsNetflix" && (
            <p className="mt-0.5 transition ease-in-out duration-300 text-left  bg-white bg-opacity-15 p-5">
