  ...
  return (
    <div className="max-w-md mx-auto p-4">
      ...
      <div className="mb-4">
        ...
        <ul>
          <li onClick={() => toggleExpand('whatIsNetflix')} className="cursor-pointer">
          ...
          <li onClick={() => toggleExpand('howMuchDoesItCost')} className="cursor-pointer">
          ...
          <li onClick={() => toggleExpand('whereCanIWatch')} className="cursor-pointer">
          ...
          <li onClick={() => toggleExpand('howDoICancel')} className="cursor-pointer">
