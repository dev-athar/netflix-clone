...
export default function List() {
  return <div>// NetflixBody.js

  import React from 'react';
  import styles from './NetflixBody.module.css'; // Import CSS module for styling
  ...
  const NetflixBody = () => {
    return (
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>Download your shows to watch offline</h2>
