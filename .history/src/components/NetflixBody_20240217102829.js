...
const NetflixBody = () => {
  ...
  return (
    <div className="w-full mx-auto p-20 bg-black text-white text-center mx-auto">
      <div className="mb-4 ">
        ...
        <img className=" pb-20" src="tv.png" alt="tv" />
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4">
        <h2 className="text-3xl font-bold mb-4">Create profiles for kids</h2>
        <p className="text-lg">
          Send kids on adventures with their favorite characters in a space made
          just for them—free with your membership.
        </p>
        <img className="p-0 scale-110 pb-20" src="kids.png" alt="Kids" />
      </div>
      <div className="mb-4">
